                        ...
                        <div class="col-xs-12">
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    <form action="${CONTEXT_PATH}/bacgrou/uploadFile" method="post" enctype="multipart/form-data">
                                        <div class="form-group">
                                            <label for="exampleInputFile">File input</label>
                                            <input type="file" id="exampleInputFile" name="upload">
                                            <p class="help-block"><a href="${CONTEXT_PATH}/bacgrou/downloadFile/${filename}">示例文件下载</a></p>
                                        </div>
