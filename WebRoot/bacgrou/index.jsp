...
<div class="login" style="margin-top:50px;">
    ...
    <div class="web_qr_login" id="web_qr_login" style="display: block; height: 235px;">    
			...
			<div class="login_form">
               ...
               <input type="text" name="type" value="pc" style="display:none;">
                <div style="padding-left:50px;margin-top:20px;margin-left: 15px;"><input type="submit" value="登 录" style="width:150px;" class="button_blue"/></div>
              </form>
           </div>
